...
impl RequestMethod for WechatCpMethod {
    fn get_method(&self) -> String {
        match self {
            ...
            WechatCpMethod::GetAdminInfo => String::from("/cgi-bin/service/get_admin_list"),
            WechatCpMethod::CorpToOpenCorpid => String::from("/cgi-bin/service/corpid_to_opencorpid"),
            WechatCpMethod::GetAppQrcode => String::from("/cgi-bin/service/get_app_qrcode"),
...
impl CpLicenseMethod {
    pub fn get_method(&self) -> String {
        match self {
            ...
            CpLicenseMethod::ListOrderAccount => String::from("/cgi-bin/license/list_order_account"),
